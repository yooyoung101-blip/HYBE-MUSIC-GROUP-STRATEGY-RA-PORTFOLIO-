(() => {
  ...
  if (tuide) {
    ...
    set($('.ssp-tuide-reference img[alt="TUIDE group"]', tuide), {
      id:'TUIDE-BENCHMARK-SCOUT-BENCH-HQ', artist:'TUIDE', section:'Benchmark',
      ...
      source:'TUIDE scout-session public high-resolution image mirror',
    ...
    set($('.ssp-tuide-reference img[alt="OURBIRTHDAY group"]', tuide), {
      id:'OURBIRTHDAY-BENCHMARK-OBD-BLUE-HQ', artist:'OURBIRTHDAY', section:'Benchmark',
  ...
  document.documentElement.dataset.imageRegistry = '18h-internet-originals';
})();